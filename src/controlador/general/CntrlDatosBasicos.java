...
<<<<<<< HEAD
	List<DatoBasico> listaDatoBasico, listaDatoBasicoB, listaDatoBasicoC;
	Boolean editar;
	Integer index, pos;
...
<<<<<<< HEAD
		listaDatoBasico  = new ArrayList<DatoBasico>();
=======
...
<<<<<<< HEAD
						...
						listaDatoBasico = servicioDatoBasico.buscarPorTipoDato(tipoDato.getTipoDato().getTipoDato().getTipoDato());						

						if (listaDatoBasico.size() > 0) {							
							llenarCombo(cmbDatoBasicoA, listaDatoBasico);							
=======
...
<<<<<<< HEAD
					...
					listaDatoBasico = servicioDatoBasico.buscarPorTipoDato(tipoDato.getTipoDato().getTipoDato());
...
<<<<<<< HEAD
				...
				listaDatoBasico = servicioDatoBasico.buscarPorTipoDato(tipoDato.getTipoDato());												
...
<<<<<<< HEAD
	...
	public void onChange$cmbDatoBasicoC(){		
		DatoBasico db = (DatoBasico) cmbDatoBasicoC.getSelectedItem().getValue();	
		llenarListaDatos();
	}
...
<<<<<<< HEAD
	...
	public void onClick$btnAgregar() {
		if (cmbTipoDato.getValue().equals("--SELECCIONE--")){
			...
			String nombreTipoDato =  altenarMayuscula(cmbTipoDato.getSelectedItem().getLabel());			
		if (!editar) {			
			if (cmbDatoBasicoA.isVisible() && cmbDatoBasicoA.getValue().equals("--SELECCIONE--")) {
					alert("Seleccione el " + lblDatoBasicoA.getValue() + " al que le desea asociar el(la) " + nombreTipoDato);
					cmbDatoBasicoA.focus();
				} else if (cmbDatoBasicoB.isVisible() && cmbDatoBasicoB.getValue().equals("--SELECCIONE--")) {
						alert("Seleccione el " + lblDatoBasicoB.getValue() + " al que le desea asociar el(la) " + nombreTipoDato);
						cmbDatoBasicoB.focus();
					}
					else if (cmbDatoBasicoC.isVisible() && cmbDatoBasicoC.getValue().equals("--SELECCIONE--")) {
							alert("Seleccione el " + lblDatoBasicoC.getValue()+ " al que le desea asociar el(la) "+ nombreTipoDato);
							cmbDatoBasicoC.focus();
						} else if (txtNombre.getValue().isEmpty()) {
								alert("Debe introducir el Nombre del(de la) "+ nombreTipoDato+ " que desea Registrar");
								txtNombre.focus();
							} else if (txtDescripcion.getValue().isEmpty()) {
									alert("Debe introducir la Decripcion del(de la) " + nombreTipoDato+ " que desea Registrar");
									...
									while (i < lboxDatos.getItems().size()) {
										...
										if (txtNombre.getValue().equals(lc.getLabel())) {
											alert("El(la) "+ nombreTipoDato+ " ya se encuentra registrado(a)");
											txtNombre.focus();
											repetido = true;
											break;
										}
									...
									if (!repetido) {
										datoBasico.setCodigoDatoBasico(servicioDatoBasico.listar().size() + 2);
										datoBasico.setTipoDato((TipoDato) cmbTipoDato.getSelectedItem().getValue());
										if (cmbDatoBasicoC.isVisible()) {
											datoBasico.setDatoBasico((DatoBasico) cmbDatoBasicoC.getSelectedItem().getValue());
										} else {
											if (cmbDatoBasicoB.isVisible()) {
												datoBasico.setDatoBasico((DatoBasico) cmbDatoBasicoB.getSelectedItem().getValue());
											} else {
												if (cmbDatoBasicoA.isVisible()) {
													datoBasico.setDatoBasico((DatoBasico) cmbDatoBasicoA.getSelectedItem().getValue());
												} else {
										...
										datoBasico.setDescripcion(txtDescripcion.getValue().toUpperCase());
										datoBasico.setEstatus('A');										
										llenarListbox(lboxDatos,(String)txtNombre.getValue().toUpperCase(),(String) txtDescripcion.getValue().toUpperCase(),""+lboxDatos.getSelectedItem().getValue());
										txtNombre.setValue("");
										txtDescripcion.setValue("");
										servicioDatoBasico.agregar(datoBasico);
										try {
											Messagebox.show("El(la) "+ nombreTipoDato+ " ha sido guardado con Exito");
...
<<<<<<< HEAD
					if (txtNombre.getValue().toUpperCase().equals(lcA.getLabel())) {
						if (txtNombre.getValue().toUpperCase() != nombre) {
							alert("El(la) " + nombreTipoDato + " ya se encuentra registradoq(a)");
=======
...
<<<<<<< HEAD
					...
					alert("Debe introducir la Decripcion del(de la) "
							+ nombreTipoDato + " que desea Registrar");
					txtDescripcion.focus();
				} else if (!repetido) {
					datoBasico.setNombre(txtNombre.getValue().toUpperCase());
...
>>>>>>> 8f481b99d9d0e3c8f37c34b5688d08ccc5f6c118
					...
					txtDescripcion.setValue("");
<<<<<<< HEAD
					alert("El(la) " + nombreTipoDato + " se ha actualizado con exito");
					editar = false;
				}
			}
		}							
