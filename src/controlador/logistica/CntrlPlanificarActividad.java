...
public class CntrlPlanificarActividad extends GenericForwardComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		db.setCodigoDatoBasico(501);
		setTiposActividades(servicioDatoBasico.buscarDatosPorRelacion(db));
...
// botones  	
	...
	public void onClick$btnGuardar(){
		...
		actividadPlanificada.setDatoBasico(tipoActividad.getDatoBasico());
